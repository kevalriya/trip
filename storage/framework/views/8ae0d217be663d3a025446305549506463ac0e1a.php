...
<?php $__env->startSection('title','TripOn - Booking'); ?>
  ...
  <?php $__env->startSection('footerSection'); ?>
	  <script type="text/javascript">
        ...
        function uuidv4() {
            ...
            FlutterwaveCheckout({
            public_key: "<?php echo e(env('PAYMENT_PUBLIC_KEY')); ?>",
            tx_ref: "ONTRIP-" + uuidv4(),
            amount: document.getElementById("totalTripAmount").value,
            currency: "NGN",
            country: "NG",
            payment_options: " ",
            // redirect_url: "<?php echo e(route('searchRes')); ?>",
            meta: {
                consumer_id: 23,
                consumer_mac: "92a3-912ba-1192a",
            },
            customer: {
                email: "<?php echo e(Auth::guard('web')->user()->EMAIL_ADDRESS); ?>",
                phone_number: "<?php echo e(Auth::guard('web')->user()->PHONE_NUMBER_COUNTRY); ?> <?php echo e(Auth::guard('web')->user()->PHONE_NUMBER1); ?>",
                name: "<?php echo e(Auth::guard('web')->user()->FIRSTNAME); ?> <?php echo e(Auth::guard('web')->user()->SURNAME); ?>",
            },
            ...
            customizations: {
                ...
                logo: "<?php echo e(url('images/icons/color_logo.png')); ?>",
            },
            });
        }
	    ...
	    function addData(paymentData) {
            ...
            if(paymentData.status === "successful" || paymentData.status === "pending") {
                $.ajax({
                    url: "<?php echo e(route('bookingPayment')); ?>",
                    type: 'POST',
...
*/
 ...
 $(document).on('click', ".ins-chk", function(e) {
  ...
  function totalTicket() {
  	var total='<?php echo e($TRIP->FARE); ?>';
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/trip/resources/views/front/bus-booking.blade.php ENDPATH**/ ?>