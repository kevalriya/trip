...
<?php $__env->startSection('title','TripOn - Buses search results'); ?>
<?php $__env->startSection('headSection'); ?>

<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
<link rel="stylesheet" href="<?php echo e(asset('front/css/fontawesome-stars.css')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                               ...
                               <li class="hidden-xs">
                                ...
                                <p class="text-right">Not what you're looking for? <a href="<?php echo e(route('home')); ?>" >Try your search again</a>
                                </p>
                            </div>
                        </div>
                        <div class="gap"></div>
...
<script src="<?php echo e(asset('front/js/jquery.barrating.min.js')); ?>" type="text/javascript"></script>
...
$(document).on('click', '.view-seat-ng', function(event) {
    ...
    var oldvalsid=$('#'+uid+'-main').val('X');
       ...
       $('.insert_seat').load("<?php echo e(route('seatmap')); ?>",{ _token: "<?php echo e(csrf_token()); ?>",bustype:bustype,uid:uid,route_id:route_id,pickup_id:pickup_id,return_id:return_id,bus_id:bus_id,seat:seat,startDate:startDate,trip_id:trip_id,endDate:endDate},function(){
...
$("input[name='bustypes[]']:checked").each(function(){busTypes.push($(this).val());});
    ...
    $.ajax({
        url: "<?php echo e(route('searchRes')); ?>",
        type: "POST",
        data : { _token: "<?php echo e(csrf_token()); ?>",fromtxt:fromtxt,totxt:totxt,pickup_id:from,return_id:to,passengerid:passengerid,isreturn:isreturn,dpdate:startdate,busTypes:busTypes,operator:operator,classtype:classtype,dptime:dptime,amenitie:amenitie,price:price,returning:returning},
       success: function(data){
    ...
    closeBtnInside: true,
	 ...
	 callbacks : {
        ...
        var trip=tz.attr('data-trip');
           $.ajax({
              type: "POST",
			  data:{ _token: "<?php echo e(csrf_token()); ?>",busid:busid,routeid:routeid,fromtxt:fromtxt,totxt:totxt,toid:toid,trip:trip},
              url: "<?php echo e(route('routeDetail')); ?>",
  ...
  function checkbooking(id) {
    ...
    directionsService.route({
        ...
        if (status === google.maps.DirectionsStatus.OK) {
		 ...
		 <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxtH7uIB-sE5pzeSCTIWCIBRK3JiKLYS8">
    </script> 
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/trip/resources/views/front/searchResult.blade.php ENDPATH**/ ?>