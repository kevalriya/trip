...
<?php $__env->startSection('title','TripOn - Login'); ?>
...
<?php $__env->startSection('main-content'); ?>
 ...
 <div class="col-md-6 nopadding">
                        ...
                        <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                            ...
                            <input class="form-control" name="shortName" value="<?php echo e(old('shortName')); ?>" placeholder="Short Name" type="text" />
                        </div>
                   ...
                   <select class="form-control select2" name="salutation" value="<?php echo e(old('salutation')); ?>"  data-placeholder="Select LGA" aria-hidden="true">
                    ...
                    <option value="<?php echo e($Salutation->SALUTATION_LABEL_ID); ?>"><?php echo e($Salutation->SALUTATION_LABEL_DESC); ?></option>
                  ...
                  <div class="col-md-5" id="login_div" style="right: 0px;">
                    ...
                    <form method="post" id="login_form">
                      <?php echo e(csrf_field()); ?>
                        ...
                        <a class="btn btn-link" href="<?php echo e(url('reset-password')); ?>">
  ...
  <p class="alert alert-success ssmsg"><?php echo e(session('message')); ?></p>
<?php endif; ?>
    <?php if(session()->has('warning')): ?>
  <p class="alert alert-warning ssmsg"><?php echo e(session('warning')); ?></p>
<?php endif; ?>
            ...
            <div class="tab-pane fade" id="ltab-2">
                      ...
                      <?php echo e(csrf_field()); ?>
                        ...
                        <button class="btn btn-primary sub_btn" type="submit" />Sign in <i class="fas fa-sign-in-alt"> </i> </button>
                        <a class="btn btn-link" href="<?php echo e(url('reset-operator-password')); ?>">
                                    Forgot Your Password?
                                </a>
                    </form>
          <br>
  ...
  <script type="text/javascript">
    ...
    $('.reg_btn').find('.fa').addClass('fa-refresh fa-spin');
      ...
      $.ajax({
        ...
        url: "<?php echo e(route('reg_response')); ?>",
        type: 'POST',
 ...
 return false;
    ...
    $('.oreg_btn').find('.fa').removeClass('fa-sign-in-alt').addClass('fa-refresh fa-spin');
      ...
      $.ajax({
        ...
        url: "<?php echo e(route('op_reg_response')); ?>",
        type: 'POST',
 ...
 return false;
    ...
    $('.sub_btn').find('.fa').removeClass('fa-sign-in').addClass('fa-refresh fa-spin');
      $.ajax({
        ...
        url: "<?php echo e(route('login_response')); ?>",
        type: 'POST',
        ...
        // window.location.href = "<?php echo e(back()); ?>";
 ...
 return false;
    ...
    $('.sub_btn').find('.fa').removeClass('fa-sign-in').addClass('fa-refresh fa-spin');
      $.ajax({
        ...
        url: "<?php echo e(route('op_login_response')); ?>",
        type: 'POST',
        ...
        success: function(data){
          ...
          $("html, body").animate({ scrollTop: $('#loresponse').offset().top }, 500);
             ...
             window.location.href = "<?php echo e(route('operator.home')); ?>";
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/trip/resources/views/front/login.blade.php ENDPATH**/ ?>