        ...
        <div class="bg-holder">
            ...
            <div class="ri-grid" id="ri-grid">
                <ul>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/01.jpg')); ?>" alt="Image Alternative text" title="In the bokeh forest" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/02.jpg')); ?>" alt="Image Alternative text" title="Our Coffee miss u" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/03.jpg')); ?>" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL rooftop pool" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/04.jpg')); ?>" alt="Image Alternative text" title="Playstation controller" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/05.jpg')); ?>" alt="Image Alternative text" title="Gaviota en el Top" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/06.jpg')); ?>" alt="Image Alternative text" title="196_365" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/07.jpg')); ?>" alt="Image Alternative text" title="end of the day" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/08.jpg')); ?>" alt="Image Alternative text" title="lack of blue depresses me" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/09.jpg')); ?>" alt="Image Alternative text" title="Working in the Nature" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/10.jpg')); ?>" alt="Image Alternative text" title="Bekohlicious Flower" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/11.jpg')); ?>" alt="Image Alternative text" title="people on the beach" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/12.jpg')); ?>" alt="Image Alternative text" title="Sydney Harbour" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/13.jpg')); ?>" alt="Image Alternative text" title="sweet escape" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/14.jpg')); ?>" alt="Image Alternative text" title="Street" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/15.jpg')); ?>" alt="Image Alternative text" title="Play Ball" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/16.jpg')); ?>" alt="Image Alternative text" title="El inevitable paso del tiempo" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/17.jpg')); ?>" alt="Image Alternative text" title="Bekohlicious" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/18.jpg')); ?>" alt="Image Alternative text" title="Spidy" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/19.jpg')); ?>" alt="Image Alternative text" title="Sevenly Shirts - June 2012  2" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/20.jpg')); ?>" alt="Image Alternative text" title="Viva Las Vegas" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/21.jpg')); ?>" alt="Image Alternative text" title="the best mode of transport here in maldives" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/22.jpg')); ?>" alt="Image Alternative text" title="The Big Showoff-Take 2" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/23.jpg')); ?>" alt="Image Alternative text" title="a turn" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/24.jpg')); ?>" alt="Image Alternative text" title="Rail Road" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/25.jpg')); ?>" alt="Image Alternative text" title="new york at an angle" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/26.jpg')); ?>" alt="Image Alternative text" title="waipio valley" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/27.jpg')); ?>" alt="Image Alternative text" title="pink flowers" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/28.jpg')); ?>" alt="Image Alternative text" title="cascada" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/29.jpg')); ?>" alt="Image Alternative text" title="a dreamy jump" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/30.jpg')); ?>" alt="Image Alternative text" title="Foots and grass" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/31.jpg')); ?>" alt="Image Alternative text" title="4 Strokes of Fun" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/32.jpg')); ?>" alt="Image Alternative text" title="Afro" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/33.jpg')); ?>" alt="Image Alternative text" title="sunny wood" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/34.jpg')); ?>" alt="Image Alternative text" title="b and w camera" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/35.jpg')); ?>" alt="Image Alternative text" title="drifting days" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/36.jpg')); ?>" alt="Image Alternative text" title="AMaze" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/37.jpg')); ?>" alt="Image Alternative text" title="Pictures at the museum" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/38.jpg')); ?>" alt="Image Alternative text" title="The Hidden Power of the Heart" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/39.jpg')); ?>" alt="Image Alternative text" title="Street Yoga" />
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo e(url('images/front/40.jpg')); ?>" alt="Image Alternative text" title="Sorry to Bust Your Bubble" />
                        </a>
                    </li>
                </ul>
            </div>
