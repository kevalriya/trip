                                                ...
                                                <div class="row text-center">
                                                    <div class="col-md-1 col-xs-3 text-center" style="margin-bottom: 10px">
                                                        <div class="booking-item-airline-logo">
                                                            ...
                                                            ?>
                                                            <img src="images/operator/<?php echo e($Route->FLEET_PHOTO); ?>" alt="Image Alternative text" title="Image Title">
                                                        <?php } ?>
                                                            <p><?php echo e($Route->OPERATOR_LEGAL_NAME); ?></p>
                                                        </div>


                                                        <div class="hidden-xl hidden-lg hidden-md hidden-sm col-xs-12" style="margin-top: 10px;">
                                                            <h5><span class="visible-xs">Route</span><a class="popup-text route-details" href="#small-dialog<?php echo e($Route->TRIP_ID); ?>" data-effect="mfp-zoom-out" data-bus="<?php echo e($Route->FLEET_REG_ID); ?>" data-trip="<?php echo e($Route->TRIP_ID); ?>" data-route="<?php echo e($Route->ROUTE_ID); ?>" ><i class="fa  fa-road"></i></a></h5>

                                                            <div id="small-dialog<?php echo e($Route->TRIP_ID); ?>" class="mfp-with-anim mfp-hide mfp-dialog" style="max-width: 850px; max-height: auto; "></div>                                                  
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 col-xs-9">
                                                        <div class="booking-item-flight-details">
                                                            <div class="booking-item-departure">
                                                                ...
                                                                <h5><span class="visible-xs">Departure</span><?php echo e($sDtime); ?></h5>
                                                            ...
                                                            <div class="booking-item-arrival">
                                                               <!--  <i class="fa fa-arrow-circle-down" style="font-size: 3rem; float: left; padding: 1px;"></i> -->
                                                                ...
                                                                <h5><span class="visible-xs">Arrival</span><?php echo e($sAtime); ?></h5>
...
<h5><span class="visible-xs">Seats</span><?php echo e($Route->seat_left); ?> left</h5>                                                  
</div>
...
<button class="btn btn-primary view-seat-ng seatmodal" data-type="6" data-uid="uuidinput<?php echo e($Route->TRIP_ID); ?>" data-bus="<?php echo e($Route->FLEET_REG_ID); ?>" data-trip="<?php echo e($Route->TRIP_ID); ?>" data-pic="<?php echo e($Route->ROUTE_ID); ?>" data-start="<?php echo e($startimes); ?>" data-end="<?php echo e($endtimes); ?>"	data-ret="10" data-seat="<?php echo e($Route->SEATMAP_LIB_CODE); ?>" data-route="<?php echo e($Route->ROUTE_ID); ?>">Select Seat</button>
                ...
                <div class="row" style="margin: 0px;">
                    ...
                    <div class="col-md-12 originalSeatMapHere">
                      ...
                      <div class="col-md-4">
                        <p>
						<form method="post" action="<?php echo $Url ?>" onsubmit="return checkbooking('uuidinput<?php echo e($Route->TRIP_ID); ?>')">
					   ...
					   <input type="hidden" name="jsondata" value='<?php echo json_encode($_POST); ?>' >
                        ...
                        <input type="hidden" name="seat_no" value="X" id="uuidinput<?php echo e($Route->TRIP_ID); ?>">  

                       <input type="hidden" name="seat_id" value="X" id="uuidinput<?php echo e($Route->TRIP_ID); ?>-main">      
                        ...
                        <input type="hidden" name="passenger" class="passengersel" value="<?php echo $passengerid ?>" >
                            ...
                            <br><button type="submit" class="btn btn-primary book-tripc" data-from="<?php echo e($startimes); ?>">Book your trip</button>
 ...
 ?>
<?php /**PATH /Applications/MAMP/htdocs/trip/resources/views/front/searchres.blade.php ENDPATH**/ ?>