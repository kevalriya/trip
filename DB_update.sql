...
--
-- Host: localhost:8889
-- Generation Time: Apr 26, 2021 at 08:50 PM
...
(5, 'Add new route', 'The route represents the starting point (departure) and the final point (arrival) location of a bus trip, and all intermediate stops. To create a route, complete the form below by choosing Route Name, Departure Date/Time and Arrival Date/Time; then click on the orange icon underneath the “Action” column to complete all information for stop routes.'),
(6, 'Seat Map', 'At this point, we will automatically generate the seat map for your specific bus type (fleet type). But in order to do this, you will have to fill out the form below, and click on “Generate SeatMap”. Once generated, you can re-number/re-order the seats so that they are reflective of the\nactual bus type; you can delete seats; and finally save the generated seatmap for the fleet type.'),
...
(18, 'Booking List', 'This is booking lists.'),
(19, 'FAQ', 'This is FAQ.'),
(20, 'Add FAQ', 'Add FAQ.'),
(21, 'Edit FAQ', 'Edit FAQ.'),
(22, 'Amenity Gallery', 'Amenity Gallery.'),
(23, 'Add Fleet', 'Add Fleet.'),
(24, 'Update Operator', 'Update Operator'),
(25, 'Update User', 'Update User'),
(26, 'Update City', 'Update City'),
(27, 'Update Fleet Type', 'Update Fleet Type.'),
(28, 'Update Seat Map', 'Update Seat Map.'),
(29, 'Update Fleet', 'Update Fleet.'),
(30, 'Edit Trip', 'Edit Trip'),
(31, 'Trip Schedule', 'Trip Schedule'),
(32, 'Trip Time', 'Trip Time.'),
(33, 'Trip Fare', 'Trip Fare.'),
(34, 'Start Trip', 'Start Trip.'),
(35, 'End Trip', 'End Trip.');
