    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            var $options = this.options,
                $menu = this.$elem,
                $collapser = '<div class="slimmenu-menu-collapser">'+$options.collapserTitle+'<div class="slimmenu-collapse-button"><span class="slimmenu-icon-bar"></span><span class="slimmenu-icon-bar"></span><span class="slimmenu-icon-bar"></span> <div id="navbar-close" class="hidden"><i class="fa fa-window-close" aria-hidden="true" style="font-size: 16px;"></i></div></div></div>',
                $menu_collapser;
