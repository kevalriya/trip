...
<head>
    ...
    <title>Verify Email</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="center" width="100%" style="text-align: center;">
                                    ...
                                    <h2 style="font-family: 'Roboto', sans-serif; font-weight: 400; font-size:30px; margin: 10px 0;">Your account is almost set!</h2>
                                </td>
                            </tr>
                            <tr>
                                <td height="80"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div
                                                                ...
                                                                <a href="{{url('user/verify', $User->REMEMBER_TOKEN)}}"
                                                                    style="padding: 12px 40px; border-radius: 4px; background-color: #ed8323; color: #ffffff;">Verify Email</a>
                                                            </div>
                                                        </td>
                                                    </tr>
