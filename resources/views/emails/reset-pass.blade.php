                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="center" width="100%" style="text-align: center;">
                                    <h1 style="font-family: 'Roboto', sans-serif; font-weight: 400; font-size:38px; margin: 10px 0;">Forgot Password?</h1>
                                </td>
                            </tr>
                            <tr>
                                <td height="80"></td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div
                                                                ...
                                                                <p style="color: #222f3e; ">We received a request to reset your TripOn password. Just click on the button down below to reset your password.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div
                                                                ...
                                                                <a href="{{$Token['link']}}"
                                                                    style="padding: 12px 40px; border-radius: 4px; background-color: #ed8323; color: #ffffff;">Reset Password</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                   <tr>
                                                        <td align="center">
                                                            <div style="max-width: 80%; padding: 5px 10px; text-align: center; font-family: 'Roboto', sans-serif; font-weight: 500; font-size: 14px;">
                                                                <p style="color: #747d8c; margin: 0;">If you don’t
                                                                    remember requesting this change, you may safely
                                                                    ignore this email.</p>
                                                            </div>
                                                        </td>
                                                    </tr>
