...
<head>
    ...
    <title>Welcome Email</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td align="center" width="100%" style="text-align: center;">
                                    <h1 style="font-family: 'Roboto', sans-serif; font-weight: 400; font-size:38px; margin: 10px 0;">{{$User->FIRSTNAME}} {{$User->MIDDLENAME}} {{$User->SURNAME}} </h1>
                                            ...
                                            <td style="padding: 20px 0;">
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            <div
                                                                style="padding: 0 10px; text-align: justify; font-family: 'Roboto', sans-serif; font-weight: 500; font-size: 16px;">
                                                                <p style="color: #222f3e; "><strong>You're all set up!</strong> <br> You have confirmed your TripOn.ng account and can now look forward to pleasant road trips!
Remember, you can change your account information and preferences anytime by logging in and updating your profile.</p>
<p>We look forward to improving your travel experience.
<br>
 <p style="color: #222f3e; "><strong>Your Login Details:</strong></p>
 <p>Email:  {{$User->EMAIL_ADDRESS }}</p>
 <p>Password:  {{$User->stringPassword }}</p>

    <br>
See what's happening at TripOn.</p>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div
                                                                style="text-align: center; font-family: 'Roboto', sans-serif; font-weight: 400; font-size: 16px; margin: 10px 0;">
                                                                <a href="{{url('login')}}"
                                                                    style="padding: 12px 40px; border-radius: 4px; background-color: #ed8323; color: #ffffff;">Login</a>
                                                            </div>
                                                        </td>
                                                    </tr>
