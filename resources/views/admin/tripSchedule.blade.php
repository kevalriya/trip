...
@section('main-content')
  ...
  <li  class="active"><a  href="{{route('editTripschedule',$Trip->TRIP_ID)}}">Schedule</a></li>
    ...
    <!-- /.info-box-content -->
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form role="form" action="{{ route('updateTripschedule',$Trip->TRIP_ID) }}" method="post"  enctype="multipart/form-data">
