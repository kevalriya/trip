            ...
            <div class="row"  data-gutter="60" style="min-height: 660px">
              ...
              <div class="form-group"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                ...
                                                <div class="checkbox checkbox-small">
                                                    <label>
                                                        <input class="i-check" id="usignchk" type="checkbox" />I agree to the TripOn <a hreh="">Terms of Use and Privacy Policy</a></label>
                                                    </div>
 ...
 <div class="col-md-4 nopadding">
                    ...
                    @endforeach
                       ...
                       <div class="col-md-4 nopadding">
                        <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                            ...
                            <input class="form-control" name="phone1"  placeholder="Phone No. 2" type="text" />
                        </div>
                      </div>
                  ...
                  <div class="col-md-4 nopadding">
                        <div class="form-group form-group-icon-left">
                            ...
                            <input class="form-control" name="preferredRoute"  placeholder="Password" type="Preferred Routes" />
                        </div>
                      </div>
                                            <div class="clearfix"></div>
              ...
              <div class="form-group"><i class="fa fa-lock input-icon input-icon-show"></i>
                                                ...
                                                <div class="checkbox checkbox-small">
                                                    <label>
                                                        <input class="i-check" id="osignchk" type="checkbox" />I agree to the TripOn <a hreh="">Terms of Use and Privacy Policy</a></label>
                                                    </div>
