...
@include('operator.layouts.fleetHeader')
  ...
  <div class="info-box-content">
    <span class="info-box-text">Update Fleet Type</span>
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        ...
	        <div class="box box-primary">
	          ...
	          <!-- /.box-header -->
	          <!-- form start -->
	          <form role="form" action="{{route('opupdateFleetType',$fleetType->FLEET_TYPE_CODE)}}" method="post"  enctype="multipart/form-data">
	          {{ csrf_field() }}
	          {{ method_field('PUT') }}
	            <div class="box-body">
