    ...
    <div class="box">
      <div class="box-header with-border">
        ...
        <div class="btn-group">
              ...
              <li class="update_booking_status" data-value="CANCELED BY TRAVELER" {{ ($Booking->STATUS == 'CANCELED BY HOST' || $Booking->STATUS == 'CANCELED BY TRAVELER' ) ? 'selected' : '' }}><a href="#">Cancel</a></li>
