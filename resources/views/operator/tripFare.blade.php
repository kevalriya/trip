...
@section('main-content')
  ...
  <li  ><a  href="{{route('opeditTripTime',$Trip->TRIP_ID)}}">Itinerary</a></li>
   <li class="active"><a  href="{{route('opeditTripFare',$Trip->TRIP_ID)}}">Fare</a></li>
    ...
    <!-- /.info-box-content -->
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form role="form" action="{{ route('opupdateTripFare',$Trip->TRIP_ID) }}" method="post"  enctype="multipart/form-data">
...
$CityPost=array();
  ...
  <hr>
    ...
    <?php
      ...
      echo "<h5>No Stop point found </h5>";
