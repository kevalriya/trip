...
@section('main-content')
  ...
  <!-- Apply any bg-* class to to the icon to color it -->
	  ...
	  <div class="info-box-content">
	    <span class="info-box-text">Add Trip</span>
	  ...
	  <!-- /.info-box-content -->
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        ...
	        <form role="form" action="{{ route('operator.trip.store') }}" method="post"  enctype="multipart/form-data">
...
<div class="clearfix"></div>
   		 ...
   		 <div class="form-group col-md-6">
	                <label for="name">Route</label>
	                 ...
	                 <select class="form-control select2" name="route"  data-placeholder="Select Fleet Type"  aria-hidden="true">
