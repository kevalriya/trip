...
@section('main-content')
  ...
  <li  ><a  href="{{route('opeditTripTime',$Trip->TRIP_ID)}}">Itinerary</a></li>
   <li ><a  href="{{route('opeditTripFare',$Trip->TRIP_ID)}}">Fare</a></li>
    <li class="active"> <a href="{{route('opstartTrip',$Trip->TRIP_ID)}}">Start Trip</a></li>
  ...
  <!-- Apply any bg-* class to to the icon to color it -->
	  ...
	  <div class="info-box-content">
	    <span class="info-box-text">Start Trip</span>
	  ...
	  <!-- /.info-box-content -->
	    ...
	    <div class="row">
	      <div class="col-md-12">
	        ...
	        <form role="form" action="{{ route('opeditstartTrip',$id) }}" method="post"  enctype="multipart/form-data">
